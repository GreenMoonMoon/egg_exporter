                    ...
                    if f.material_index < len(obj.data.materials):
                        ...
                        for link in mat.node_tree.links:
                            ...
                            #            uv_name = ''
                                    ...
                                    tex_list[textureNode.name] = {'path': t_path, 'scalars': scalars, 'transform': transform}
                ...
                for f in obj.data.polygons:
                    if f.material_index < len(obj.data.materials):
                        ...
                        for tex in valid_slots:
                            ...
                            if tex.texture.yabee_name not in list(tex_list.keys()):
                                ...
                                # tex_list[tex.texture.name] = {'path': t_path, 'scalars': scalars, 'transform': transform }
                                tex_list[tex.texture.yabee_name] = {'path': t_path, 'scalars': scalars, 'transform': transform }
